/*$file${.::sawcontroller.ino} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*
...
/*$declare${AOs::Indicator} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*${AOs::Indicator} ........................................................*/
...
/*$declare${AOs::Buttons} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*${AOs::Buttons} ..........................................................*/
...
/*$enddecl${AOs::Buttons} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*$declare${AOs::Stage} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*${AOs::Stage} ............................................................*/
...
static QState Stage_HomeInitB(Stage * const me);
...
static QState Stage_SeekHomeB(Stage * const me);
...
static QState Stage_GoPastHome(Stage * const me);
static QState Stage_HomeInitD(Stage * const me);
static QState Stage_HomeInitC(Stage * const me);
static QState Stage_HomeFromLeft(Stage * const me);
static QState Stage_HomeInitE(Stage * const me);
static QState Stage_HomeInitF(Stage * const me);
...
#endif
/*$endskip${QP_VERSION} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*$define${AOs::Indicator} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*${AOs::Indicator} ........................................................*/
/*${AOs::Indicator::SM} ....................................................*/
static QState Indicator_initial(Indicator * const me) {
...
/*$define${AOs::Buttons} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*${AOs::Buttons} ..........................................................*/
/*${AOs::Buttons::SM} ......................................................*/
static QState Buttons_initial(Buttons * const me) {
...
/*$enddef${AOs::Buttons} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*$define${AOs::Stage} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*${AOs::Stage} ............................................................*/
/*${AOs::Stage::SM} ........................................................*/
static QState Stage_initial(Stage * const me) {
...
static QState Stage_FindHome(Stage * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case OPTICALSTOP_A_SIG: {
            status_ = Q_TRAN(&Stage_HomeInitC);
            break;
        }
        default: {
            status_ = Q_SUPER(&QHsm_top);
...
static QState Stage_HomeInit(Stage * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case Q_TIMEOUT_SIG: {
            doStepA();
            status_ = Q_TRAN(&Stage_HomeInitB);
            break;
        }
        default: {
...
/*${AOs::Stage::SM::FindHome::HomeInitB} ...................................*/
static QState Stage_HomeInitB(Stage * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Stage::SM::FindHome::HomeInitB::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            doStepB();
            status_ = Q_TRAN(&Stage_HomeInit);
            break;
...
static QState Stage_SeekHome(Stage * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case Q_TIMEOUT_SIG: {
            ...
            Serial.println("");
            #endif
            status_ = Q_TRAN(&Stage_SeekHomeB);
            break;
        }
        default: {
...
/*${AOs::Stage::SM::CutSequence::SeekSuper::SeekHomeB} .....................*/
static QState Stage_SeekHomeB(Stage * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Stage::SM::CutSequence::SeekSuper::SeekHomeB::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            doStepB();
            /*${AOs::Stage::SM::CutSequence::SeekSuper::SeekHomeB::Q_TIMEOUT::[foundcutpos]} */
            if (me->CurrentStep == cutsteparray[me->CurrentCut]) {
                /*${AOs::Stage::SM::CutSequence::SeekSuper::SeekHomeB::Q_TIMEOUT::[foundcutpos]::[checkfinished]} */
                if (me->CurrentCut == (TotalCuts-1)) {
                    status_ = Q_TRAN(&Stage_Complete);
                }
                /*${AOs::Stage::SM::CutSequence::SeekSuper::SeekHomeB::Q_TIMEOUT::[foundcutpos]::[else]} */
                else {
                    status_ = Q_TRAN(&Stage_CutSequence);
                }
            }
            /*${AOs::Stage::SM::CutSequence::SeekSuper::SeekHomeB::Q_TIMEOUT::[else]} */
            else {
                status_ = Q_TRAN(&Stage_SeekHome);
            }
            break;
...
static QState Stage_GoPastHome(Stage * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case Q_ENTRY_SIG: {
            ...
            setStepperSpeed(&me->super, BSP_TICKS_PER_SEC/MotorStepDivider);
            RedOnGreenOn();
            me->CurrentStep = 1000; // because it is unsigned
            status_ = Q_HANDLED();
            break;
        }
        /*${AOs::Stage::SM::GoPastHome} */
...
/*${AOs::Stage::SM::GoPastHome::HomeInitD} .................................*/
static QState Stage_HomeInitD(Stage * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Stage::SM::GoPastHome::HomeInitD::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            doStepB();
            me->CurrentStep += counterAdjust;
            /*${AOs::Stage::SM::GoPastHome::HomeInitD::Q_TIMEOUT::[me->CurrentStep>900]} */
            if (me->CurrentStep > 900) {
                status_ = Q_TRAN(&Stage_HomeInitC);
            }
            /*${AOs::Stage::SM::GoPastHome::HomeInitD::Q_TIMEOUT::[else]} */
            else {
                status_ = Q_TRAN(&Stage_HomeInitE);
            }
            break;
        }
        default: {
            status_ = Q_SUPER(&Stage_GoPastHome);
            break;
        }
    }
    return status_;
}
/*${AOs::Stage::SM::GoPastHome::HomeInitC} .................................*/
static QState Stage_HomeInitC(Stage * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Stage::SM::GoPastHome::HomeInitC::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            doStepA();

            status_ = Q_TRAN(&Stage_HomeInitD);
            break;
        }
        default: {
            status_ = Q_SUPER(&Stage_GoPastHome);
...
static QState Stage_HomeFromLeft(Stage * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*${AOs::Stage::SM::HomeFromLeft::OPTICALSTOP_A2} */
        case OPTICALSTOP_A2_SIG: {
...
/*${AOs::Stage::SM::HomeFromLeft::HomeInitE} ...............................*/
static QState Stage_HomeInitE(Stage * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Stage::SM::HomeFromLeft::HomeInitE::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            doStepA();

            status_ = Q_TRAN(&Stage_HomeInitF);
            break;
        }
        default: {
            status_ = Q_SUPER(&Stage_HomeFromLeft);
            break;
        }
    }
    return status_;
}
/*${AOs::Stage::SM::HomeFromLeft::HomeInitF} ...............................*/
static QState Stage_HomeInitF(Stage * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Stage::SM::HomeFromLeft::HomeInitF::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            doStepB();
            me->CurrentStep += counterAdjust;
            status_ = Q_TRAN(&Stage_HomeInitE);
